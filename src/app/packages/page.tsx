      ...
      <div className="px-6 md:px-12 lg:px-20 py-4">
        <div className="max-w-7xl mx-auto py-16 pt-4 space-y-16 md:space-y-20">
          ...
          <section>
            ...
            <div className="-mx-6 px-6 scroll-pl-6 md:mx-0 md:px-0 md:scroll-pl-0 flex overflow-x-auto no-scrollbar snap-x snap-mandatory gap-5 pb-2 md:pb-0 md:overflow-visible md:grid md:grid-cols-3 md:gap-8">
              {[
                {
